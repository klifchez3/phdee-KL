...
* Set up your working directories
	...
	* local datapath = "/Users/kellylifchez/GaTech Dropbox/Kelly Lifchez/phdee-KL/homework1" // Typically, where you keep the data and where you want the outputs to go will be different.  In this sample code, this is not the case so I don't specify a data path.
	local outputpath = "/Users/kellylifchez/GaTech Dropbox/Kelly Lifchez/phdee-KL/homework1/output" 
