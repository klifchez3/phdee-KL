...
month_labels = ['Jan 2017', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec',
                'Jan 2018', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec']
...
plt.savefig(os.path.join(outputpath, 'trend_plot.pdf'), bbox_inches='tight', pad_inches=0.1)
